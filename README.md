...
Java SDK for the [Flametrench v0.1](https://github.com/flametrench/spec) authorization specification: relational tuples and exact-match `check()`. No rewrite rules in v0.1; that's a v0.2+ feature per [ADR 0001](https://github.com/flametrench/spec/blob/main/decisions/0001-authorization-model.md).
